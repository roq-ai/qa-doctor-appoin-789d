...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'healthcare_provider.update': {
    roles: ['business-owner', 'office-manager'],
    key: 'healthcare-provider-update',
    tenantPath: ['organization', 'healthcare_provider'],
    userPath: [],
  },
  'appointment.create': {
    roles: ['business-owner', 'office-manager', 'healthcare-provider', 'receptionist'],
    key: 'new-appointment',
...
const tenantRoles: string[] = ['business-owner', 'office-manager', 'healthcare-provider', 'receptionist'];
