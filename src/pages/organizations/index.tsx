...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'appointment.count', 'healthcare_provider.count', 'patient.count', 'receptionist.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('patient', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('receptionist', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'receptionist',
          header: 'Receptionist',
          accessorKey: 'receptionist',
          cell: ({ row: { original: record } }: any) => record?._count?.receptionist,
        }
      : null,
