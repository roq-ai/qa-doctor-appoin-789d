...
import { getReceptionistById } from 'apiSdk/receptionists';
import { ReceptionistInterface } from 'interfaces/receptionist';

function ReceptionistViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('receptionist', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/receptionists/edit/${id}`} passHref legacyBehavior>
                    <Button
